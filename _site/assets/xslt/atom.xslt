...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Arthur Brock's Personal Site</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a href="http://localhost:4000/deeper">Deeper</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/metacurrency">Metacurrency</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/metacurrency/faq">FAQ</a></li>
                    

                      

                      <li><a href="http://localhost:4000/metacurrency/resources">Resources</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/targeted-currencies">Targeted currencies</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/targeted-currencies/about">About</a></li>
                    

                      

                      <li><a href="http://localhost:4000/targeted-currencies/vision">Vision</a></li>
                    

                      

                      <li><a href="http://localhost:4000/targeted-currencies/blog">Blog</a></li>
                    

                      

                      <li><a href="http://localhost:4000/targeted-currencies/documents">Documents</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/threebles">Threebles</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/threebles/strategy">Strategy</a></li>
                    

                      

                      <li><a href="http://localhost:4000/threebles/google-presentation">Google presentation</a></li>
                    

                      

                      <li><a href="http://localhost:4000/threebles/google-project">Google project</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/lifeblood">Lifeblood</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/lifeblood/about">About</a></li>
                    

                      

                      <li><a href="http://localhost:4000/lifeblood/dynamic-alignment">Dynamic alignment</a></li>
                    

                      

                      <li><a href="http://localhost:4000/lifeblood/tools">Tools</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/blog">Articles</a>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000" title="Arthur Brock's Personal Site – Building a world that works for all">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Arthur Brock's Personal Site – Building a world that works for all">
			</a>
