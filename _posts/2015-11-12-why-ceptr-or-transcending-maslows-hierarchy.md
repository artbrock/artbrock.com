...
So, while I'm in favor of good stories, I don't think they'll get us to where we need to go. That's <strong>why we're building Ceptr so that we have the basic building blocks for composing the real "current-sees" needed for collaboration on this scale</strong>, just like the cells in our body have numerous living/dynamic signalling systems for coordinating their actions.
