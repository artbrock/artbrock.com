...
Two months later, on the first week of March 2017, we had our [first Hackathon in San Francisco](/ceptr/hackathons) for people to build apps on Holochain.
...
Our first weekend hackathon yielded [HoloChat](/holochain/holochat) (a multichannel Slack-like chat), [TrustGraph](#) (for making decentralized, censor-proof, reputational claims), and two versions of Clutter, a twitter clone -- [one in JavaScript](/holochain/clutter) and [one in Lisp](/holochain/cludder), which both used the same UI.
...
We worked over the next six months improving networking, enhancing testing, benchmarking performance, and learning the [design patterns](/holochain/mixins) and idioms of building agent-centric dApps on an eventually-consistent, sharded, validating DHT.
...
Out of those events came about 60 pretty cool Holochain apps to various stages of completion. They ranged from proof-of-concept of back-end features to pretty polished experiences with a full UI. Some noteworthy ones that come to mind:
 ...
 - [DPKI](/holochain/dpki): Distribute Public Key Infrastructure -- crypto-key management,
 - [HoloDex](/holochain/holodex): Indexing overlay app for searching a sharded DHT,
 - [hAppStore](/holochain/HCHC): A distributed directory for distributing distributed apps),
 - [Fractal Wiki](/holochain/fractal-wiki): structure wiki of nexted cards (like Decko),
 - [Transactor](/holochain/transactor): A basic mutual credit currency,
 - [Touchpoints](/holochain/touchpoints): Mobile NFC enabled interaction logging system,
 - [Federated Wiki](/holochain/fedwiki),
 ...
 - [Electric Smart Meter Mgt](/holochain/smart-meter-mgmt): IoT data recording /  sharing / kilowatt balancing
 - [UnMute](/holochain/unmute) censor-proof blogging like Medium.com (later evolved into [humm.earth](https://humm.earth)),
 - [HoloVault / Personas](/holochain/holovault) personal data and identity management,
 - [New Craigslist](/holochain/craigs-list): self-explanatory -- *also implemented in OCaml,
 - [HoloChess](/holochain/holochess),
 - [Battleship](#),
 - [Massively Multiplayer Pong](#),
 - [MinerSweeper](#): Real-time-ish multi-player minesweeper,
 - [Errand](/holochain/errand): Trello-like kanban boards for tasks,
 - [Omni](/OmniProject/omni): For publication of scholarly peer reviewed articles,
...
So we designed [HOLO](/holo) as a major project to be able to bridge obscure and marginalized crypto-apps to mainstream users by letting them just use their web browser as if it were any data-driven web site. We know Holochain has no inherent speed or scale bottlenecks, so that theoretically these Holo-hosted apps could scale to the size of Facebook or Twitter. And there wasn't a blockchain-based project out there who could get anywhere near our performance or ease of devlopment.
...
Luckily, there are few projects (like [Humm.Earth](/humm)) that ignored our warnings and did go live on the Go version of Holochain.  But there were not enough of these for the community at large to take Holochain seriously.
